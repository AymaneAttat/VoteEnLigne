<form method="POST" action="{{ route('vote_deadline.store') }}">
    @csrf    
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Cette date sera effectuer pour toute les candidats.
                                    </p>
                                    <div class="mt-4">
                                        <x-input class="block mt-1 w-full" type="date" name="end_vote" :value="old('end_vote')" required autofocus />
                                    </div>
